...
var runtime = require("@luwfy/red-runtime")(instance_id);
var redUtil = require("@luwfy/red-util")(instance_id);

var api = require("@luwfy/red-editor-api")(instance_id);
...
var result = {
    ...
    init: function(httpServer, userSettings) {
        ...
        if (!userSettings.coreNodesDir) {
            userSettings.coreNodesDir = path.dirname(require.resolve("@luwfy/red-nodes"))
        }
