<script type="text/x-red" data-template-name="xml">
    <div class="form-row">
        <label for="node-input-property"><i class="fa fa-ellipsis-h"></i> Input message</label>
        <input type="text" id="node-input-property" style="width:70%;"/>
    </div>
    <div class="form-row">
        <label for="node-input-property_out"><i class="fa fa-ellipsis-h"></i> Output message</label>
        <input type="text" id="node-input-property_out" style="width:70%;"/>
    </div>
    <div class="form-row">
...
<script type="text/javascript">
    RED.nodes.registerType('xml',{
        ...
        defaults: {
            ...
            property_out: {value:"payload",required:true},
            attr: {value:""},
            chr: {value:""}
        },
        inputs:1,
        ...
        oneditprepare: function() {
            ...
            if (this.property_out === undefined) {
                $("#node-input-property_out").val("payload");
            }
            $("#node-input-property_out").typedInput({default:'msg',types:['msg']});
