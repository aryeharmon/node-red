...
<script type="text/x-red" data-template-name="file">
    ...
    <div class="form-row node-input-dirname">
         <label for="node-input-dirname"><i class="fa fa-file"></i> File Directory</label>
         <input id="node-input-dirname" type="text">
    </div>
    <div class="form-row">
         <label for="node-input-input_name">input_name</label>
         <input id="node-input-input_name" type="text" data-i18n="[placeholder]file.label.input_name">
    </div>
    <div class="form-row">
...
<script type="text/x-red" data-template-name="file in">
    ...
    <div class="form-row">
         <label for="node-input-output_name">output_name</label>
         <input id="node-input-output_name" type="text" data-i18n="[placeholder]file.label.output_name">
    </div>
    <div class="form-row">
