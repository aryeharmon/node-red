...
module.exports = function(RED) {
    ...
    function FileNode(n) {
        ...
        function processMsg(msg, done) {
            //node.filename = Handlebars.compile(n.dirname)({msg: msg}) + '/' + Handlebars.compile(n.filename)({msg: msg});
            node.filename = Handlebars.compile(n.dirname)({msg: msg}) + '/' + Handlebars.compile(n.filename)({msg: msg});
            ...
            if (filename === "") {
            ...
            } else if (_.get(msg, node.input_name || 'payload')) {
                ...
                var data = _.get(msg, node.input_name || 'payload');
                    ...
                    .on('end', function() {
                        if (node.chunk === false) {
                            if (node.format === "utf8") {
                                ...
                                _.set(msg, node.output_name || 'payload', decode(lines, node.encoding));
                            } else { 
                                // msg.payload = lines;
                                _.set(msg, node.output_name || 'payload', lines);
                            }
                            node.send(msg);
                        }
