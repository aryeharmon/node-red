            ...
            if (this.payloadType !== 'flow' && this.payloadType !== 'global') {
                try {
                    if ( (this.payloadType == null && this.payload === "") || this.payloadType === "date") {
                        ...
                        _.set(msg, node.output_name || 'payload', Date.now());
                    } else if (this.payloadType == null) {
                        // msg.payload = this.payload;
                        _.set(msg, node.output_name || 'payload', this.payload);
                    } else if (this.payloadType === 'none') {
                        // msg.payload = "";
                        _.set(msg, node.output_name || 'payload', "");
                    } else {
                        // msg.payload = RED.util.evaluateNodeProperty(this.payload,this.payloadType,this,msg);
                        _.set(msg, node.output_name || 'payload', RED.util.evaluateNodeProperty(this.payload,this.payloadType,this,msg));
                    }
                    this.send(msg);
                    msg = null;
                } catch(err) {
                ...
                RED.util.evaluateNodeProperty(this.payload,this.payloadType,this,msg, function(err,res) {
                    if (err) {
                        ...
                        // msg.payload = res;
                        _.set(msg, node.output_name || 'payload', res);
                        node.send(msg);
                    }
