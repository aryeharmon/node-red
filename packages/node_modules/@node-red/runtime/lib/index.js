...
var redUtil = require("@luwfy/red-util")(instance_id);
var log = redUtil.log;
 ...
 * @param {AdminAPI} adminApi - an instance of @luwfy/red-editor-api. <B>TODO</B>: This needs to be
 *                              better abstracted.
 * @memberof @luwfy/red-runtime
 */
...
var runtime = {
    ...
    library: library,
    exec: exec,
    util: require("@luwfy/red-util")(instance_id).util,
...
var result = {
    ...
    /**
    * @memberof @luwfy/red-runtime
    * @mixes @luwfy/red-runtime_comms
    */
    comms: externalAPI.comms,
    /**
    * @memberof @luwfy/red-runtime
    * @mixes @luwfy/red-runtime_flows
    */
    flows: externalAPI.flows,
    /**
    * @memberof @luwfy/red-runtime
    * @mixes @luwfy/red-runtime_library
    */
    library: externalAPI.library,
    /**
    * @memberof @luwfy/red-runtime
    * @mixes @luwfy/red-runtime_nodes
    */
    nodes: externalAPI.nodes,
    /**
    * @memberof @luwfy/red-runtime
    * @mixes @luwfy/red-runtime_settings
    */
    settings: externalAPI.settings,
    /**
    * @memberof @luwfy/red-runtime
    * @mixes @luwfy/red-runtime_projects
    */
    projects: externalAPI.projects,
    /**
    * @memberof @luwfy/red-runtime
    * @mixes @luwfy/red-runtime_context
    */
