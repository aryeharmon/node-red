...
var needsPermission;
var runtimeAPI;
var log = require("@luwfy/red-util")(instance_id).log; // TODO: separate module
var i18n = require("@luwfy/red-util")(instance_id).i18n; // TODO: separate module
...
var result = {
    ...
    start: function() {
        var catalogPath = path.resolve(path.join(path.dirname(require.resolve("@luwfy/red-editor-client")),"locales"));
